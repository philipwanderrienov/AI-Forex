...
Next: target preview/apply tools/migrate_runit_spool.py with MT5 closed; verify external spool and 851 quarantine pairs. Compile 1.062 readiness diagnostics. See deployment/runit/README.md.
